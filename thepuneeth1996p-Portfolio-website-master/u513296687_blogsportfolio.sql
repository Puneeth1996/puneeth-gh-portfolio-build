...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 30, 2020 at 04:37 PM
...
--
-- Database: `u513296687_blogsportfolio`
--
...
INSERT INTO `donation` (`id`, `userName`, `Amount`, `phone_number`, `other_details`, `description`, `dated`) VALUES
(13, 'puneeth', '10', '9066339217', 'This me testing out', '', '2020-08-30 16:30:09');
...
CREATE TABLE `students` (
  ...
  `personal_url` varchar(255) NOT NULL,
...
INSERT INTO `students` (`id`, `userName`, `email`, `amount`, `phone_number`, `other_details`, `description`, `personal_url`, `dated`) VALUES
(1, 'parshuram.B', 'puneeth1996p@gmail.com', '1500', '+919066339217', 'This me testing out', 'asfdadfa sdfad ', '', '2020-08-30 16:36:08');
...
(1, '127.0.0.1', 'administrator', '$2y$12$t52CE.EPrTIxnqjG5dO6XebSj4iD34udI6FvpwAoTx5VJ/XU19hxm', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1598804946, 1, 'Admin', 'istrator', 'ADMIN', '0'),
...
--
ALTER TABLE `blogs`
  MODIFY `blog_id` int(155) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
